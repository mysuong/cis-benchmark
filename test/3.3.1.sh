...
checkipv4_1="$(grep -E -s "^\s*net\.ipv4\.conf\.all\.accept_source_route\s*=\s*0$" /etc/sysctl.conf /etc/sysctl.d
/*.conf /usr/lib/sysctl.d/*.conf /run/sysctl.d/*.conf)"
checkipv4_2="$(grep -E -s "^\s*net\.ipv4\.conf\.default\.accept_source_route\s*=\s*0$" /etc/sysctl.conf /etc
...
$?
 checkipv6_1="$(grep -E -s "^\s*net\.ipv6\.conf\.all\.accept_source_route\s*=\s*0$" /etc/sysctl.conf /etc/sysctl.d
/*.conf /usr/lib/sysctl.d/*.conf /run/sysctl.d/*.conf)"
 checkipv6_2="$(grep -E -s "^\s*net\.ipv6\.conf\.default\.accept_source_route\s*=\s*0$" /etc/sysctl.conf /etc
/sysctl.d/*.conf /usr/lib/sysctl.d/*.conf /run/sysctl.d/*.conf)"
